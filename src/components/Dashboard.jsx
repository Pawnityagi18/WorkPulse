    ...
    <section style={{ padding: '3.5rem 0' }}>
      <div className="container">
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontSize: '2rem', fontWeight: 800 }}>
              {isClient ? 'Employer Workspace & Escrow Hub' : 'Freelancer Earnings & Active Contracts'}
            </h2>
          </div>
          {/* Role Mode Indicator */}
          <span className={`badge ${isClient ? 'badge-verified' : 'badge-category'}`} style={{ padding: '0.5rem 1rem', fontSize: '0.85rem' }}>
            Current Role: {isClient ? 'Employer / Client' : 'Freelancer / Talent'}
          </span>
        </div>
        ...
        <div style={{
          ...
          <div className="glass-card" style={{ padding: '1.25rem 1.5rem' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
              {isClient ? 'Pending Proposals' : 'Active Pending Bids'}
            </div>
          ...
          <div className="glass-card" style={{ padding: '1.25rem 1.5rem' }}>
            <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
              {isClient ? 'Total Project Volume' : 'Total Revenue Earned'}
            </div>
        ...
        <div style={{
          ...
          >
            <FileText size={16} /> {isClient ? `Posted Jobs (${projects.length})` : `Submitted Proposals (${proposals.length})`}
          </button>
          <button 
        ...
        {activeTab === 'posts-proposals' && (
          <>
            {isClient ? (
              ...
              /* Freelancer View of Proposals (No Client Actions) */
