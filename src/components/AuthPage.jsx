      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
          ...
          <p style={{ color: 'var(--text-muted, #64748b)', fontSize: '0.875rem', margin: 0 }}>
            {isLogin 
              ? 'Log in to continue to WorkPulse' 
        ...
        <button
          ...
          onMouseEnter={(e) => e.currentTarget.style.borderColor = 'var(--primary, #008080)'}
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.3rem' }}>
              ...
              {isLogin && (
                <button
                  type="button"
                  onClick={() => alert('Please check your SMTP email or use test login')}
